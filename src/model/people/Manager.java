...
public class Manager extends Employee {
	...
	public Manager(String employeeFName, String employeeLName, String employeeID, String employeePIN) {
	...
	// Make this function void or String? Also should there just be a function in supplier to return details and here we just call that method e.g. supplier.getDetails();
	public String getSupplierDetails(Supplier supplier) {
		String info = String.format("Name: %s %s\nID: %s\nCompany: %s\nPhone: %s\nLocation: %s\nEmail: %s\n", 
				supplier.getSupplierFName(), supplier.getSupplierLName(), supplier.getSupplierID(), supplier.getSupplierCompanyName(), supplier.getSupplierContactNo(),
				supplier.getSupplierLocation(), supplier.getSupplierEmail());
